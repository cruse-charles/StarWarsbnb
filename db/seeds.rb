...
# ApplicationRecord.transaction do 
    ...
    tatooine_l2 = Listing.create!(
      ...
      lister_id: 1,
      description: 'Welcome to my cozy home located in Anchorhead, Tatooine! This humble abode is perfect for a single traveler or a small family looking for a quiet place to stay on the planet. Featuring two bedrooms, one bathroom, and a living room, this home offers all the basics for a comfortable stay. Enjoy the desert breeze coming in from the windows, take a dip in the nearby Sarlacc pit, and wander the nearby sand dunes for a truly unique experience. Book now to experience the wonders of Tatooine!',
    ...
    kamino_l3 = Listing.create!(
      ...
      lister_id: 1,
      description: 'Come stay on the exotic planet of Kamino and enjoy the sights and sounds of this remote location. This luxury apartment is located in the heart of Kamino City and offers breathtaking views of the Tide Pools. Inside you will find a fully equipped kitchen, two bedrooms and three bathrooms, as well as a spacious living room with a large flat-screen TV. Take a stroll and enjoy the beautiful landscape or take a swim in the crystal-clear waters of the tidal pools. With its stunning views and relaxing atmosphere, this apartment is the perfect place to stay on Kamino.',
    ...
    endor_l4 = Listing.create!(
      ...
      lister_id: 3,
      description: 'Escape to the lush forests of Endor and stay in our luxurious Endor Forest Lodge. Located in the heart of the Ewok Village, this rustic yet modern home is the perfect retreat for the Star Wars enthusiast. With its open floor plan, cozy fireplaces, and breathtaking views of the forest, you\'ll feel right at home. Come explore the forests of Endor, make some new furry friends, and make memories that will last a lifetime. The Endor Forest Lodge has all the modern amenities you need to make your stay comfortable and enjoyable. So come and experience the wonders of Endor and relax in the comfort of this peaceful home.',
    ...
    naboo_l5 = Listing.create!(
      ...
      lister_id: 3,
      description: 'This luxurious home located on the waterfront of Theed, Naboo, provides spectacular views of the city and the surrounding lake. The house features four bedrooms and three bathrooms, with plenty of space to accommodate a large family or group of friends. The living room is cozy and inviting, and the open kitchen is fully stocked with all of the modern amenities. The large deck overlooks the lake and offers a perfect spot for watching the sunset. The master bedroom is spacious and features a large en suite bathroom, and the other bedrooms have plenty of room for a comfortable night\'s sleep. The garden surrounding the house is lush and tranquil, and the perfect spot for a peaceful evening stroll. ',
    ...
    ahch_to_l7 = Listing.create!(
      ...
      lister_id: 3,
      description: 'This tranquil and secluded retreat is located in the heart of Ahch-To. Boasting gorgeous views of the surrounding landscape, this home is perfect for an escape from the hustle and bustle of everyday life. With a spacious living area and bedrooms, you\'ll have plenty of room to stretch out and relax. The large deck is perfect for entertaining and taking in the surrounding beauty. The property also includes a well-maintained garden and is surrounded by lush greenery, providing a peaceful oasis. Whether you\'re looking for a peaceful getaway or just a place to call home, this Ahch-To retreat is the perfect spot. Come and experience the beauty and serenity of this unique location.',
    ...
    trask_l8 = Listing.create!(
      ...
      lister_id: 4,
      description: 'Located in the enchanting world of Trask, this magnificent home is perfect for anyone looking for a unique, unforgettable getaway. The property includes two bedrooms, two bathrooms, and a large living area with a cozy fireplace. The kitchen is updated and modern, and includes a breakfast nook that overlooks lush green gardens. The outside of the home is majestic and will take your breath away. There is a large patio and backyard area for entertaining and for enjoying the peaceful atmosphere of this amazing world. Whether you are looking for a quiet escape or an adventure, this home is the perfect place to relax and enjoy all that Trask has to offer.',
